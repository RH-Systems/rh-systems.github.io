...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; -webkit-tap-highlight-color: transparent; }
    ...
    #networkCanvas { position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; opacity: 0.6; pointer-events: none; }
    ...
    .team-grid {
        display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 350px), 1fr)); gap: 40px; margin-top: 60px;
    }
    .profile-card {
...
<section id="team">
    <div class="container">
        ...
        <div class="team-grid">
            <a href="https://rh-systems.github.io/Raj-Hridoy/" class="profile-card fade-up">
            ...
            <a href="https://rh-systems.github.io/Riyad-Hasan/" class="profile-card fade-up">
                <div class="profile-header">
                    <div class="avatar-placeholder">RH</div>
                    <h3>Riyad Hasan</h3>
